...
function addElement() {
  if (document.querySelector(".addTxt").value.trim() != "") {
    let date = document.querySelector(".task_date")
    elements.push(document.querySelector(".addTxt").value.trim() + "&nbsp;&nbsp;:&nbsp;&nbsp; " + date.value.trim());
...
function display() {
  ...
  for (var i = 0; i < elements.length; i++)
    document.querySelector(".list").innerHTML +=
      ...
      i +
      ")'><img class='trash' src = 'https://icons.iconarchive.com/icons/papirus-team/papirus-status/512/user-trash-full-icon.png' onclick='del(" +
      i +
      ")'></div></div></center><br>"
      };
